import React, { useEffect, useState } from "react"; // Added useState for fallback
  ...
  return (
    <div className="Home">
      ...
      <Helmet>
        ...
        <meta
          name="keywords"
          content="banana pudding, dessert, Houston, Humble TX, Dishtalgia, Bananas Foster"
        />
      ...
      <Container sx={{ paddingY: 4 }}>
        ...
        >
          ...
          <Typography
            ...
            sx={{
              color: "orange",
              fontWeight: "bold",
              textShadow: "rgb(0, 0, 0) .5px 1px 3px",
            }}
          >
          ...
          >
            Try a sample of our delicious banana pudding! Available at: Twisted
            Creole Food Truck | Located @ Porky's Backyard, 5131 Atascocita
            Road, Humble, TX 77346
          </Typography>
        </motion.div>
          ...
          >
            ...
            >
              ...
              >
                <img
                  src="/DBFBP.png"
                  alt="Best Bananas Foster Pudding Houston"
                  style={{ width: "100%", borderRadius: 10 }}
                />
        ...
        >
          ...
          <ul style={{ fontSize: "1.2rem", color: "#555", lineHeight: "1.8" }}>
            <li>
              Banana pudding has been a **Southern dessert favorite** since the
              late 19th century.
            </li>
            <li>
              The first known banana pudding recipe was published in **1878** in
              "Housekeeping in Old Virginia".
            </li>
            <li>
              Traditional banana pudding is made with **vanilla wafers,
              bananas, and custard**—but we made ours even better! 😉
            </li>
            <li>
              There's an **Annual National Banana Pudding Festival** held in
              Tennessee every October! 🎉
            </li>
          </ul>
        </Paper>
